...
class Data():
    ...
    def get_tokenizer(self):
        ...
        def tokenizer(article, summary, max_article_len, max_summary_len):
            ...
            extended_tokenized_article += [stop_decoding] + [pad_token for i in range(max_article_len - len(article_words))]
            ...
            extended_tokenized_summary += [stop_decoding] + [pad_token for i in range(max_summary_len - len(summary_words))]
        ...
        def generator():
            ...
            for file in tqdm(all_files):
                ...
                while True:
                    ...
                    extended_tokenized_article, extended_tokenized_summary, oovs = text_tokenizer(article, summary, max_article_len, max_summary_len)
...
class Batcher():
    ...
    def get_all_data(self):
        ...
        with tf.device('CPU'):
            ...
            summary_loss_points = [[1 for i in range(x)]+[0 for i in range(summary_max_len-x)] for x in summary_lens]
